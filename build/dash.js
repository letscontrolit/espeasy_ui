...
/***/ "./src/plugins/dashboard/api.js":
/*!**************************************!*\
  !*** ./src/plugins/dashboard/api.js ***!
  \**************************************/
/*! exports provided: getVariables, loadDashboardConfig, storeDashboardConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const loadDashboardConfig = api.espeasy.loadDashboardConfig;
const storeDashboardConfig = api.espeasy.storeDashboardConfig;

/***/ }),

/***/ "./src/plugins/dashboard/dashboard.editor.js":
/*!***************************************************!*\
  !*** ./src/plugins/dashboard/dashboard.editor.js ***!
  \***************************************************/
...
/* harmony import */ var _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dashboard_node_definitions */ "./src/plugins/dashboard/dashboard_node_definitions.js");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/plugins/dashboard/api.js");
...
class DashboardEditorPage extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    this.pages = [];
    this.nodes = _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_2__["nodes"];

    this.saveConfig = () => {
      const config = this.pages.map(page => {
        return {
          title: page.title,
          nodes: page.chart.saveConfig()
        };
      });
      Object(_api__WEBPACK_IMPORTED_MODULE_3__["storeDashboardConfig"])(JSON.stringify(config));
    };
    ...
    this.selectTab = (e, tabIndex) => {
      ...
      elements.forEach((element, i) => {
        if (i === parseInt(tab)) element.classList.add('active');else element.classList.remove('active');
      });
    };
  }
  ...
  createPage(page) {
    ...
    this.menu.appendChild(menu); // add tab
  ...
  renderChart(domNode, elements) {
    const chart = new _lib_floweditor__WEBPACK_IMPORTED_MODULE_1__["FlowEditor"](domNode, _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_2__["nodes"], {
      gridSize: 10,
      debug: false
    });
  ...
  render(props) {
    ...
    return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      class: "dash_menu"
    }, Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("ul", null, Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      style: "display: inline",
      ref: ref => this.menu = ref
    }), Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("li", null, Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("a", {
      onClick: this.addPage
    }, "add page")))), Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      class: "dash_menu_right"
    }, Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("a", {
      onClick: this.saveConfig
    }, "SAVE"))), Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("ul", {
      class: "tabs",
  ...
  componentDidMount() {
    Object(_api__WEBPACK_IMPORTED_MODULE_3__["getVariables"])().then(out => {
      const varNode = _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_2__["nodes"].find(node => node.type === 'VARIABLE');
      const meterNode = _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_2__["nodes"].find(node => node.type === 'METER');
      const imageNode = _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_2__["nodes"].find(node => node.type === 'IMAGE_METER');
      Object.keys(out).forEach(v => {
        varNode.config[0].values.push(v);
        meterNode.config[0].values.push(v);
        imageNode.config[0].values.push(v);
      });
      Object(_api__WEBPACK_IMPORTED_MODULE_3__["loadDashboardConfig"])().then(configs => {
...
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.mjs");
/* harmony import */ var _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard_node_definitions */ "./src/plugins/dashboard/dashboard_node_definitions.js");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api */ "./src/plugins/dashboard/api.js");
...
class DashboardPage extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  render(props) {
    return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      ...
      return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("li", {
        ...
        const node = _dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_1__["nodes"].find(n => n.type === cfg.t);
  ...
  componentDidMount() {
    Object(_api__WEBPACK_IMPORTED_MODULE_2__["loadDashboardConfig"])().then(config => {
      this.setState({
        pages: config
      });
    });
    ...
    const timeout = async () => {
      const variables = await Object(_api__WEBPACK_IMPORTED_MODULE_2__["getVariables"])();
      this.setState({
        vals: variables
      });
...
/***/ "./src/plugins/dashboard/dashboard_node_definitions.js":
/*!*************************************************************!*\
  !*** ./src/plugins/dashboard/dashboard_node_definitions.js ***!
  \*************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dashboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard */ "./src/plugins/dashboard/dashboard.js");
/* harmony import */ var _dashboard_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard.editor */ "./src/plugins/dashboard/dashboard.editor.js");
...
const menu = {
  ...
  href: 'dashboard',
  class: 'full',
  component: _dashboard__WEBPACK_IMPORTED_MODULE_0__["DashboardPage"],
  children: [{
    title: 'Editor',
    pagetitle: '',
    href: 'dashboard/editor',
    class: 'full',
    component: _dashboard_editor__WEBPACK_IMPORTED_MODULE_1__["DashboardEditorPage"]
  }]
};
