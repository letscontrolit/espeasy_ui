...
/* harmony import */ var _33_dummy_device__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./33_dummy_device */ "./src/devices/33_dummy_device.js");
...
}, //{ name: 'Communication - IR', value: 16, fields: bh1750 },
{
  ...
  value: 33,
  fields: _33_dummy_device__WEBPACK_IMPORTED_MODULE_20__["dummyDevice"]
}];
/*
...
const parseConfig = (data, config, start) => {
  ...
  config.map(value => {
    ...
    Object(lodash__WEBPACK_IMPORTED_MODULE_0__["set"])(result, value.prop, p[value.type](prop, value.signed));
  });
  return result;
};
const writeConfig = (buffer, data, config, start) => {
  ...
  if (start) p.offset = start;
  config.map(value => {
    const val = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(data, value.prop);
...
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.mjs");
/* harmony import */ var _lib_dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/dashboard_node_definitions */ "./src/lib/dashboard_node_definitions.js");
...
class DashboardPage extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  render(props) {
    return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      ...
      const node = _lib_dashboard_node_definitions__WEBPACK_IMPORTED_MODULE_1__["nodes"].find(n => n.type === cfg.t);
      ...
      return Object(preact__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
        ...
        dangerouslySetInnerHTML: {
          __html: node.toHtml.bind(context)()
        }
      });
    }));
  }
  ...
  componentDidMount() {
    Object(_lib_espeasy__WEBPACK_IMPORTED_MODULE_2__["loadDashboardConfig"])().then(config => {
      this.setState({
        config
      });
    });
